...
/**
 * @author alecliu The ExternalMocks class is a utility class used to configure mocked versions of
 * the game object. It exposes multiple layers of configuration, allowing for layered testing.
 */
public class PreconfiguredGameMock {
