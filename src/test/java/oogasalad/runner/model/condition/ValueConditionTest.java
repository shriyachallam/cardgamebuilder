...
class ValueConditionTest {
  ...
  void test() {
    ...
    ValueCondition condition = new ValueCondition(Map.of("group_tag", "group"), null);
    ...
    Card card2 = new StandardCard(StandardSuit.HEART, StandardValue.ACE);
    Card card3 = new StandardCard(StandardSuit.SPADE, StandardValue.ACE);
    Card card4 = new StandardCard(StandardSuit.CLUB, StandardValue.TWO);
    group.add(card1);
    assertTrue(condition.isValid(group));
    group.add(card2);
    assertTrue(condition.isValid(group));
