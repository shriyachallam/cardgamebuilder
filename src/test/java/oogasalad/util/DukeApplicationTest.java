...
public class DukeApplicationTest extends ApplicationTest {
    ...
    /**
     * Run given view method as a JFX callback, allowing you to add/remove components from the Scene or Stage.
     */
    protected void runAsJFXAction (Runnable action) {
        // fire event using given callback on the given node
    ...
    // HACKs: needed to get simulating UI callback working :(
