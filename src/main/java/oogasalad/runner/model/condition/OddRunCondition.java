...
/*
checks that there is a consecutive sequence of odd cards with the same incrementation and all the same suit
 */
public class OddRunCondition extends GroupCondition{

  public OddRunCondition(Map<String, String> params, Board board){
    super(params, board);
  }
